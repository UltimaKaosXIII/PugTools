...
namespace PugTools {
  internal sealed class WorldEffect : SlimDXNet.FX.Effect {
    public readonly EffectTechnique Lit, AlphaTestLit, AlphaLit, AddLit, MultiplyLit, HookOverlay, HookAdditive, Unlit, Sky, TerrainCoverage, TerrainLit, TerrainAddLit, TerrainUnlit, TerrainAddUnlit, Height, Wire, Water, Overlay, MapArt, Shadow, AlphaShadow, InstancedLit, InstancedAlphaTestLit, InstancedAlphaLit, InstancedUnlit, InstancedWire, InstancedShadow, DynamicDetail, DynamicDetailShadow, TemporalAA, Fxaa, PostProcess;
    private readonly EffectMatrixVariable world, worldInvTranspose, viewProj, shadow0, shadow1, shadow2, shadow3, localProjectorInv, taaReprojection;
    private readonly EffectVectorVariable camera, pointLight, frontLight, ambient, advanced, fog0, fog1, fogSky, fogParams, fogColorParams, shadowSplits, heightRange, overlay, materialFlatColor, materialBloomParams, scrollOffset, scrollVisual, terrainChunkScale, materialUvScale, envBlend1, envBlend2, dydCameraRight, dydCreationDistances, dydParams, dydTextureInfo;
    private readonly EffectVectorVariable localPosRange, localColorIntensity, localDirType, localProjectorParams;
    private readonly EffectVectorVariable waterDeep, waterShallow, waterGloss, waterNmOffsets, waterParams, waterParams2, waterParams3, waterAlpha1, waterAlpha2, waterAlpha3, waterAlpha4, taaParams0, taaParams1;
    private readonly EffectScalarVariable enableLighting, enableFog, enableShadows, localCount, alphaMode, alphaTest, diffuseAlphaMax, materialUsesEmissive, hookOpacity, terrainUv, hasDiffuse, hasDiffuse2, hasRotation, hasGloss, hasTerrainMask, hasTerrainColor, hasIllumination, scrollingEnabled, hasEnvBlend, envBlendCrevice, envBlendTileMult, timeSeconds, hasColorLut, mapArtOpacity;
    ...
    public WorldEffect(Device device, string filename) : base(device, filename) {
      ...
      Lit=FX.GetTechniqueByName("Lit"); AlphaTestLit=FX.GetTechniqueByName("AlphaTestLit"); AlphaLit=FX.GetTechniqueByName("AlphaLit"); AddLit=FX.GetTechniqueByName("AddLit"); MultiplyLit=FX.GetTechniqueByName("MultiplyLit"); HookOverlay=FX.GetTechniqueByName("HookOverlay"); HookAdditive=FX.GetTechniqueByName("HookAdditive"); Unlit=FX.GetTechniqueByName("Unlit"); Sky=FX.GetTechniqueByName("Sky");
      TerrainCoverage=FX.GetTechniqueByName("TerrainCoverage"); TerrainLit=FX.GetTechniqueByName("TerrainLit"); TerrainAddLit=FX.GetTechniqueByName("TerrainAddLit"); TerrainUnlit=FX.GetTechniqueByName("TerrainUnlit"); TerrainAddUnlit=FX.GetTechniqueByName("TerrainAddUnlit");
      Height=FX.GetTechniqueByName("Height"); Wire=FX.GetTechniqueByName("Wire"); Water=FX.GetTechniqueByName("Water"); Overlay=FX.GetTechniqueByName("Overlay"); MapArt=FX.GetTechniqueByName("MapArt"); Shadow=FX.GetTechniqueByName("Shadow"); AlphaShadow=FX.GetTechniqueByName("AlphaShadow");
      InstancedLit=FX.GetTechniqueByName("InstancedLit"); InstancedAlphaTestLit=FX.GetTechniqueByName("InstancedAlphaTestLit"); InstancedAlphaLit=FX.GetTechniqueByName("InstancedAlphaLit"); InstancedUnlit=FX.GetTechniqueByName("InstancedUnlit"); InstancedWire=FX.GetTechniqueByName("InstancedWire"); InstancedShadow=FX.GetTechniqueByName("InstancedShadow");
      DynamicDetail=FX.GetTechniqueByName("DynamicDetail"); DynamicDetailShadow=FX.GetTechniqueByName("DynamicDetailShadow"); TemporalAA=FX.GetTechniqueByName("TemporalAA"); Fxaa=FX.GetTechniqueByName("FXAA"); PostProcess=FX.GetTechniqueByName("PostProcess");
      world=FX.GetVariableByName("World").AsMatrix(); worldInvTranspose=FX.GetVariableByName("WorldInvTranspose").AsMatrix(); viewProj=FX.GetVariableByName("ViewProj").AsMatrix();
      ...
      heightRange=FX.GetVariableByName("HeightRange").AsVector(); overlay=FX.GetVariableByName("OverlayColor").AsVector(); materialFlatColor=FX.GetVariableByName("MaterialFlatColor").AsVector(); materialBloomParams=FX.GetVariableByName("MaterialBloomParams").AsVector(); scrollOffset=FX.GetVariableByName("ScrollingOffsetParams").AsVector(); scrollVisual=FX.GetVariableByName("ScrollingVisualParams").AsVector(); terrainChunkScale=FX.GetVariableByName("TerrainChunkScale").AsVector(); materialUvScale=FX.GetVariableByName("MaterialUvScale").AsVector(); envBlend1=FX.GetVariableByName("EnvBlendParams1").AsVector(); envBlend2=FX.GetVariableByName("EnvBlendParams2").AsVector();
    ...
    public void SetMaterial(GR2_Material m) {
      ...
      string derived=m?.derived ?? String.Empty; bool selfLit=m?.useEmissive == true || derived.Equals("EmissiveOnly",StringComparison.OrdinalIgnoreCase) || derived.StartsWith("AnimatedUV",StringComparison.OrdinalIgnoreCase) || derived.StartsWith("AnimatedVFX",StringComparison.OrdinalIgnoreCase) || derived.StartsWith("AnimatedFlipbook",StringComparison.OrdinalIgnoreCase); materialUsesEmissive.Set(selfLit ? 1 : 0);
